...
<body class="flex justify-center items-center h-screen bg-gray-200">
    ...
    <div class="text-center">
        ...
        <div class="w-80 sm:w-96 mx-auto mt-8 bg-white rounded-sm p-5">
            <form action="index.php" method="post" class="flex flex-col gap-5">

                <span class="text-zinc-600">Welcome 😊! Insert your email and password</span>
                <div class="relative">
                    <input name="email" type="email" placeholder="Email" class="h-10 border border-zinc-300 bg-white rounded-sm px-3" required>
                    <span class="material-symbols-outlined absolute z-10 mt-2 right-3 text-zinc-500">
                        mail
                    </span>
                </div>
